...
|------|------|----------|----------|----------|
| WSL | ⭐⭐ | ⭐⭐⭐⭐⭐ | 🔥 Windows新手首选 | [WSL 安装教程](docs/wsl/wsl-setup.md) |
| Windows | ⭐⭐ | ⭐⭐⭐ | Windows有经验用户 | [Windows 安装指南](docs/windows/windows-install-guide.md) |
| macOS | ⭐⭐ | ⭐⭐⭐⭐⭐ | macOS用户 | [macOS 安装指南](docs/macos/macos-install-guide.md) |
| Linux | ⭐ | ⭐⭐⭐⭐⭐ | Linux用户 | [Linux 安装指南](docs/linux/linux-install-guide.md) |
| Docker | ⭐⭐⭐ | ⭐⭐⭐⭐ | 熟悉Docker的用户 | [Docker 部署教程](docs/docker/docker-deployment.md) |
| 云服务器 | ⭐⭐⭐ | ⭐⭐⭐⭐⭐ | 需要24小时在线的用户 | [云服务器部署指南](docs/cloud/cloud-deployment-guide.md) |
| Android | ⭐⭐⭐⭐ | ⭐⭐⭐ | 移动部署用户 | [Android 部署指南](docs/android/android-deployment-guide.md) |
