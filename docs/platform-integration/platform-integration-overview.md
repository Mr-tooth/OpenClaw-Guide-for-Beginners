...
|------|----------|----------|----------|------|
| 飞书 | ⭐⭐ | ⭐⭐⭐⭐⭐ | [详细教程](feishu.md) | 企业协作，功能丰富 |
| 钉钉 | ⭐⭐ | ⭐⭐⭐⭐ | [详细教程](dingtalk.md) | 企业办公，集成度高 |
| Telegram | ⭐ | ⭐⭐⭐⭐ | [详细教程](telegram.md) | 海外首选，配置简单 |
| 微信 | ⭐⭐⭐ | ⭐⭐⭐ | [详细教程](wechat.md) | 用户基数大，门槛较高 |
...
- [API 配置详解](../api-config/README.md) - AI 模型配置
- [云服务器部署](../cloud/README.md) - 公网访问配置
- [OpenClaw 官方文档](https://docs.openclaw.ai)

---

**上一页**：[API 配置详解](../api-config/README.md) | **下一页**：[飞书对接教程](feishu.md)
